...
@section('title', 'Kelola Pengguna | Admin Masjid')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('admin.users.create') }}" class="btn btn-success px-3 py-2 fw-semibold" style="border-radius: 0.75rem;">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center text-muted py-4">Belum ada data warga yang diimport atau terdaftar.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
